...
/**
 * Created by 牛海丰 on 2016/12/5.
 */

public class NotificationButton02 extends Button {
    ...
    public NotificationButton02(Context context) {
        super(context);
        paint = new Paint();
        paint.setAntiAlias(true);
    }

    public NotificationButton02(Context context, AttributeSet attrs) {
        super(context, attrs);
        initProperty(context, attrs);
    }

    public NotificationButton02(Context context, AttributeSet attrs, int defStyleAttr) {
