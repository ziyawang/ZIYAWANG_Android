...
public class PublishCompanyActivity extends BenBenActivity implements View.OnClickListener {
    //数据加载的dialog
    ...
    //经营情况
    private TextView text_is_ing ;
    //有无设全相关凭证
    private TextView text_has_pingzheng ;
    //债权涉诉情况
    private TextView text_shesu ;
    //债务方行业
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        release_img_cancel_one.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (release_frame_two.getVisibility() == View.VISIBLE) {
                    ToastUtils.shortToast(PublishCompanyActivity.this, "无法删除第一张图片");
                } else {
        ...
        release_img_cancel_two.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (release_frame_three.getVisibility() == View.VISIBLE) {
                    ToastUtils.shortToast(PublishCompanyActivity.this, "无法删除第二张图片");
                } else {
        ...
        /***************************************录音 上划取消*****************************************/
        //检查广播录制的权限
        if (ActivityCompat.checkSelfPermission(PublishCompanyActivity.this, Manifest.permission.RECORD_AUDIO) != PackageManager.PERMISSION_GRANTED) {
            ToastUtils.shortToast(PublishCompanyActivity.this, "请在管理中心，给予录音相应权限。");
        } else if (ActivityCompat.checkSelfPermission(PublishCompanyActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            ToastUtils.shortToast(PublishCompanyActivity.this, "请在管理中心，给予使用相机权限。");
        } else {
                        ...
                        switch (event.getAction()) {
                            ...
                            case MotionEvent.ACTION_UP: {
                                ...
                                if (moveTime < 500) {
                                    ...
                                    ToastUtils.shortToast(PublishCompanyActivity.this, "时间太短，无法录制");
                                    window.dismiss();
                                    ...
                                    //release_audio_cancel.setVisibility(View.GONE);
                                    //stopRecorder();
                                    ToastUtils.shortToast(PublishCompanyActivity.this, "时间过长，无法继续录制");
                                    ...
                                    release_audio_cancel.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            if (isOK) {
                                                //播放录制的音频文件
                                                mPlayer = new MusicPlayer(PublishCompanyActivity.this);
                                                String s = mPlayer.playMicFile(recAudioFile);
                                                Log.e("benbne", s);
                                                ToastUtils.shortToast(PublishCompanyActivity.this, "正在播放音频");
                                            } else {
                                                ToastUtils.shortToast(PublishCompanyActivity.this, "已经取消上传");
                                            }
                                        }
                                    });
                                    voice_cancel.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            hasVoice = false;
                                            ToastUtils.shortToast(PublishCompanyActivity.this, "撤销语音成功，请重新录制");
                                            voice_cancel.setVisibility(View.GONE);
                                            release_audio_cancel.setVisibility(View.GONE);
    ...
    private void picGet01() {
        ...
        camera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(PublishCompanyActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                    ToastUtils.shortToast(PublishCompanyActivity.this, "请在管理中心，给予相机相应权限。");
                    window.dismiss();
                } else {
        ...
        switch (requestCode) {
            case 1:
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    Toast.makeText(PublishCompanyActivity.this, "请重新选择图片", Toast.LENGTH_SHORT).show();
                }
                break;
            case 2:
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    Toast.makeText(PublishCompanyActivity.this, "请重新获取图片", Toast.LENGTH_SHORT).show();
                }
                break;
            case 3:
                if (resultCode == Activity.RESULT_OK) {
    ...
    public boolean isSubmit(){
        if (text_id.getText().toString().equals("请选择")) {
            ToastUtils.shortToast(PublishCompanyActivity.this , "请选择您的身份");
            return false ;
        }
        if (text_type.getText().toString().equals("请选择")) {
            ToastUtils.shortToast(PublishCompanyActivity.this , "请选择企业商账类型");
            return false ;
        }
        if (TextUtils.isEmpty(edit_total_money.getText().toString().trim())){
            ToastUtils.shortToast(PublishCompanyActivity.this , "请输入债权金额");
            return false ;
        }
        if (TextUtils.isEmpty(edit_over_time.getText().toString().trim())){
            ToastUtils.shortToast(PublishCompanyActivity.this , "请输入逾期时间");
            return false ;
        }
        if (TextUtils.isEmpty(text_type_01.getText().toString()) && TextUtils.isEmpty(text_type_02.getText().toString())){
            ToastUtils.shortToast(PublishCompanyActivity.this , "请选择处置方式及佣金");
            return false ;
        }
        if (text_part.getText().toString().equals("请选择")) {
            ToastUtils.shortToast(PublishCompanyActivity.this , "请选择债务方地区");
            return false ;
        }
        if (text_company_type.getText().toString().equals("请选择")) {
            ToastUtils.shortToast(PublishCompanyActivity.this , "请选择债务方企业性质");
            return false ;
        }
        if (text_is_ing.getText().toString().equals("请选择")) {
            ToastUtils.shortToast(PublishCompanyActivity.this , "请选择债务方经营情况");
            return false ;
        }

        if (TextUtils.isEmpty(edit_des.getText().toString().trim())){
            ToastUtils.shortToast(PublishCompanyActivity.this , "请输入文字描述");
            return false ;
        }
        if (release_frame_one.getVisibility() != View.VISIBLE) {
            ToastUtils.shortToast(PublishCompanyActivity.this , "请至少添加一张图片");
            return false ;
        }
        if (TextUtils.isEmpty(edit_name.getText().toString().trim())){
            ToastUtils.shortToast(PublishCompanyActivity.this , "请输入联系人姓名");
            return false ;
        }
        if (TextUtils.isEmpty(edit_phone.getText().toString().trim())){
            ToastUtils.shortToast(PublishCompanyActivity.this , "请输入联系方式");
            return false ;
        }
        if (!edit_phone.getText().toString().trim().matches("^(0|86|17951)?(13[0-9]|15[012356789]|17[3678]|18[0-9]|14[57])[0-9]{8}$")){
            ToastUtils.longToast(PublishCompanyActivity.this, "请输入正确的手机号码");
            return false ;
        }
        return true ;
    }
    ...
    public void initViews() {
        ...
        text_company_type = (TextView)findViewById(R.id.text_company_type ) ;
        text_is_ing = (TextView)findViewById(R.id.text_is_ing ) ;
        text_has_pingzheng = (TextView)findViewById(R.id.text_has_pingzheng ) ;
        text_shesu = (TextView)findViewById(R.id.text_shesu ) ;
        text_hangye = (TextView)findViewById(R.id.text_hangye ) ;
    ...
    public void initListeners() {
        ...
        text_company_type.setOnClickListener(this);
        text_is_ing.setOnClickListener(this);
        text_has_pingzheng.setOnClickListener(this);
        text_shesu.setOnClickListener(this);
        text_hangye.setOnClickListener(this);
    ...
    private void loadData() {
        ...
        params.addBodyParameter("TypeID" , "18");
        ...
        params.addBodyParameter("Money" , edit_total_money.getText().toString() );
        ...
        params.addBodyParameter("Nature" , text_company_type.getText().toString() );
        params.addBodyParameter("Status" , text_is_ing.getText().toString() );
        params.addBodyParameter("Guaranty" , "请选择".equals(text_has_pingzheng.getText().toString().trim())?"":text_has_pingzheng.getText().toString().trim()   );
        params.addBodyParameter("State" , "请选择".equals(text_shesu.getText().toString().trim())?"":text_shesu.getText().toString().trim()   );
        params.addBodyParameter("Industry" , "请选择".equals(text_hangye.getText().toString().trim())?"":text_hangye.getText().toString().trim()  );
        String proLabel = "" ;
        if (one){
        ...
        httpUtils.send(HttpRequest.HttpMethod.POST, urls, params, new RequestCallBack<String>() {
            ...
            public void onSuccess(ResponseInfo<String> responseInfo) {
                ...
                try {
                    ...
                    switch (status_code){
                        case "200" :
                            ToastUtils.shortToast(PublishCompanyActivity.this , "发布成功");
                            finish();
                            break;
                        default:
                            ToastUtils.shortToast(PublishCompanyActivity.this , "发布失败");
                            break;
                    }
            ...
            public void onFailure(HttpException error, String msg) {
                ...
                ToastUtils.shortToast( PublishCompanyActivity.this , "网络连接异常");
            }
        }) ;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.checkbox_type_02 :
                ...
                break;
            case R.id.text_part :
                startActivityForResult(new Intent(PublishCompanyActivity.this, PartActivity.class), 4);
                break;
            case R.id.text_company_type :
                popUpWindow(text_company_type) ;
                break;
            case R.id.text_is_ing :
                popUpWindow(text_is_ing ) ;
                break;
            case R.id.text_has_pingzheng :
                popUpWindow(text_has_pingzheng ) ;
                break;
            case R.id.text_shesu :
                popUpWindow(text_shesu ) ;
                break;
            case R.id.text_hangye :
                popUpWindow(text_hangye ) ;
                break;
            case R.id.text_one :
                showView(text_one) ;
                break;
                ...
                try {
                    ...
                    switch (status_code) {
                        case "200":
                            ...
                            ToastUtils.longToast(PublishCompanyActivity.this, "委托发布成功,请您耐心等待资芽网客服与您联系。");
                            finish();
                            break;
                        default:
                            submit.setEnabled(true);
    ...
    private void showBenDialog() {
        /* 显示ProgressDialog */
        //在开始进行网络连接时显示进度条对话框
        dialog = new MyProgressDialog(PublishCompanyActivity.this , "数据提交中，请稍后。。。");
        // 不可以用“返回键”取消
    ...
    private boolean isOtherSubmit(EditText person, EditText phone) {
        ...
        if (TextUtils.isEmpty(phone.getText().toString().trim())){
            ToastUtils.shortToast(PublishCompanyActivity.this , "请输入联系电话");
            return false ;
        }
        return true ;
    }
