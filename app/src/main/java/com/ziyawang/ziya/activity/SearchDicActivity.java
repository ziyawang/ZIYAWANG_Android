...
public class SearchDicActivity extends BenBenActivity implements View.OnClickListener {
    ...
    public void setContentView() {
        setContentView(R.layout.activity_search_dic);
    }
    ...
    public void initViews() {
        ...
        footLinearLayout = (LinearLayout) LayoutInflater.from(SearchDicActivity.this).inflate(R.layout.home_foot_item ,null ) ;
        ben = (TextView)footLinearLayout.findViewById(R.id.ben ) ;
        adapter = new V3DicAdapter(SearchDicActivity.this, datas);
        ...
        switch (v.getId()){
            ...
            case R.id.search_button:
                if (!TextUtils.isEmpty(edit_search.getText().toString().trim())){
                    ...
                    ToastUtils.shortToast(SearchDicActivity.this , "请键入关键字在尝试搜索") ;
                }
                break;
            default:
                break;
    ...
    private void loadData() {
        //显示ProgressDialog
        dialog = new MyProgressDialog(SearchDicActivity.this , "数据加载中，请稍后。。。");
        ...
        httpUtils.send(HttpRequest.HttpMethod.POST, Url.dicSearchList, params, new RequestCallBack<String>() {
            @Override
            public void onSuccess(ResponseInfo<String> responseInfo) {
                ...
                Log.e("词典搜索", responseInfo.result);
                            ...
                            switch (scrollState) {
                                case SCROLL_STATE_IDLE:
                                    if (isListViewReachBottomEdge(absListView)){
                                        dialog = new MyProgressDialog(SearchDicActivity.this , "加载数据中请稍后。。。") ;
                                        dialog.show();
                                        Log.e("测试" , "测试" ) ;
                                        loadData();
                                    }
