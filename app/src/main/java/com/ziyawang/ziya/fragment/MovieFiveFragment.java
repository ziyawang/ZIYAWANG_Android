 ...
 */
public class MovieFiveFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_movie_five, container, false);
    }
    ...
    private void loadData() {
        ...
        params.addQueryStringParameter("VideoLabel" , "资芽一分钟");
