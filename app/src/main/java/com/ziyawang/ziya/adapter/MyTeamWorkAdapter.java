...
public class MyTeamWorkAdapter extends BaseAdapter {
    ...
    public MyTeamWorkAdapter(Context context , List<FindInfoEntity> list , String login ){
        super();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null ){
            convertView = LayoutInflater.from(context).inflate(R.layout.my_teamwork_items, parent , false);
            holder = new ViewHolder() ;

            holder.niu = (LinearLayout)convertView.findViewById(R.id.niu) ;
            holder.niu_ben = (LinearLayout)convertView.findViewById(R.id.niu_ben) ;
            ...
            holder.my_temawork_cancel = (LinearLayout)convertView.findViewById(R.id.my_temawork_cancel);
            ...
            holder.chang_status = (TextView)convertView.findViewById(R.id.chang_status);
        ...
        String a = list.get(position).getPublishState() ;
        if (a.equals("1")){
            holder.chang_status.setText("取消合作");
        }else {
            holder.chang_status.setText("取消合作中");
            holder.niu_ben.setVisibility( View.GONE );
        }
                ...
                if (a.equals("1")){
                    ...
                    builder01.setPositiveButton("确认", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(final DialogInterface dialog, int which) {
                            ...
                            String urls = String.format(Url.Cancle_TeamWork, login);
                            ...
                            httpUtils.send(HttpRequest.HttpMethod.POST, urls, params, new RequestCallBack<String>() {
                                ...
                                public void onSuccess(ResponseInfo<String> responseInfo) {
                                    ...
                                    ToastUtils.shortToast(context , "取消合作成功");
                                    holder.chang_status.setText("取消合租中");
                                ...
                                public void onFailure(HttpException error, String msg) {
                                    ...
                                    ToastUtils.shortToast(context , "取消合作失败");
                                    if (dialog!=null){
                                        dialog.dismiss();
                                    }
                                }
                    ...
                    ToastUtils.shortToast(context , "取消合作中");
                }
    ...
    static class  ViewHolder{
        ...
        LinearLayout my_temawork_cancel ;
